# Source: https://towardsdatascience.com/artificial-neural-networks-optimization-using-genetic-algorithm-with-python-1fe8ed17733e

# One function call determines e.g. fitness of whole population at once!
...
for curr_sol in numpy.arange(0, sol_per_pop):
    ...
    input_HL1_weights = numpy.random.uniform(low=-0.1, high=0.1, 
                                             ...
                                             size=(6 # here 6(7): speedX, speedY, posX, gapX, pipeSpeed, distance to next Pipe(,distance to last pipe)
                                                    , HL1_neurons)) # aber lieber einer box ein NN brain geben, also viel ummodeln
